...
| [errors-and-results.md](./errors-and-results.md) | Terminal outcomes; pre-evaluation failure surface (ERR-1…ERR-7, ERR-16); no-rollback (ERR-8…ERR-13); runtime panics + message templates; `QueryError` variant schemas (ERR-14, ERR-15, ERR-17, ERR-19); final value (FN-5) | `errors-and-results.md`, `errors-and-results/error-model.md`, `errors-and-results/queryerror-variants.md`, `functions.md`, `query/*`, `invocation.md` | complete |
