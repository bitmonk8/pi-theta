...
//
// This module owns the parse-time check and shared template model for the
// `system:` frontmatter field; resolve-time rendering lives in system-prompt-render.ts.
// The surface follows frontmatter/frontmatter-fields-b-and-templates.md §`system` Interpolation:
//
