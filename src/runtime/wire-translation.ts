// V2e / V2e-T — the inbound half of the wire-name translation boundary seam
// (the sidecar-indexed inbound rebuild walk); the outbound lowering and the
// rename-free AJV projection live in `wire-form-outbound.ts` and are
// re-exported here so importers resolve unchanged.
//
...
import { encodePointerSegment, isPlainObject } from "./wire-form-outbound";

export {
  translateOutbound,
  projectForValidation,
  type OutboundTranslationInput,
} from "./wire-form-outbound";
