...
// `checkImportMalformedSpecifierList` (src/parser/imports.ts:439–459) and
...
//      'from' clause with a .thetalib path literal", src/parser/imports.ts:381–382)
...
// contract, src/parser/imports.ts:461–485). Group (d) fences the STATEMENT
...
describe("bug 0100 (f) — the dangling `as`'s downstream consequences, pinned with the refusal", () => {
  ...
  it("RED (f-collision): the collapsed local name still collides, and the specifier is now refused", async () => {
    ...
    // avoid (`checkImportNameCollisions`, src/parser/imports.ts:608, compares
