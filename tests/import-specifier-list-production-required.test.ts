...
// `checkImportMalformedSpecifierList` (src/parser/imports.ts:282–302) and
// `checkImportDanglingAlias` (:294–308) read. Left unrefused, the dangling `as`
...
//      'from' clause with a .thetalib path literal", src/parser/imports.ts:224–225)
...
// contract, src/parser/imports.ts:304–328). Group (d) fences the STATEMENT
...
describe("bug 0100 (f) — the dangling `as`'s downstream consequences, pinned with the refusal", () => {
  ...
  it("RED (f-collision): the collapsed local name still collides, and the specifier is now refused", async () => {
    ...
    // avoid (`checkImportNameCollisions`, src/parser/imports.ts:451, compares
