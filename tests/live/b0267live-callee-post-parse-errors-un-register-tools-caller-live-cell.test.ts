...
const normativeMessagePattern = liveRegistryMessagePattern("bug-0267", "load");
    ...
    try {
      ...
      expect(
        ...
        `bug-0267 live cell precondition unmet: no ${UNRESOLVABLE_THETALIB_CODE} row is located ` +
          ...
          "claim — did not fire. Notes: " + JSON.stringify(collectSystemNotes(offender.sessionManager.getEntries())),
      ).not.toEqual([]);
      expect(
