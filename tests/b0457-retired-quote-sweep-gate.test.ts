...
//     scenario references, stdlib-signature.ts:29's DIFFERENT bug-0315 tail
...
const RUNTIME_PANICS = "src/runtime/stdlib-signature.ts";
const RUNTIME_PANICS_BELT_LINE = 60; // the current wrong-kind belt template (re-homed beside its throwers, PTQ-1271)
...
describe("bug 0457 — six committed surfaces quote retired normative text as current", () => {
  ...
  // =========================================================================
  it("cell C (GREEN control) — grammar.md:145 carries the optional FnParam form and stdlib-signature.ts:60 carries the current belt tail", () => {
