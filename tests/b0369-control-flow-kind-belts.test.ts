...
// shared with the b0368 sibling file (tests/helpers/runtime-belt-probe-harness.ts,
...
const { probeSource, driveInterp, driveInvoke } = makeBeltProbes(parseTheta, "b0369");
