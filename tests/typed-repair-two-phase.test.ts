...
//
// Method: the shared live two-phase harness in
// tests/helpers/scripted-live-session-harness.ts. This suite uses PER-TURN
// mid-turn hooks (the AB suite fires one hook on the FIRST turn only), so a
