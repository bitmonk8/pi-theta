...
// ===========================================================================
//
// `REGISTRY`/`REGISTRY_PATH` (aliased from the shared load-row harness's
// `PARSE_REGISTRY`/`PARSE_REGISTRY_PATH`) and the `msg`/`line` renderers below
// are `tests/helpers/load-row-harness.ts`'s shared harness (also used by
