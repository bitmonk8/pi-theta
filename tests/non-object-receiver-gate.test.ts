...
// (src/runtime/statement-executor.ts:964, object arm :971), its pure-host twin
...
//     (statement-executor.ts:739–792), including inside a user `fn` body.
...
//     pure host (statement-executor.ts:1355) is NOT usable: `theta/parse/non-array-iterand`
