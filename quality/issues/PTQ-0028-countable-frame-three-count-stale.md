...
## Triage
verdict: confirmed — both "three" comments verified (:8, :60) against a four-arm union whose fourth arm is pushed in production (producer:3033, statement-executor:627, each +1 to the one counter); spec §INV-4 itself names four classes, and blame shows `subagent-fn` landed 2026-07-21 after the 2026-07-01 "three" prose (triage: claude-opus-5)
