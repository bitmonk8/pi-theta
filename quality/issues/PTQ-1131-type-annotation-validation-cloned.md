...
## Triage
verdict: confirmed — all four excerpts match at the cited lines; clone-scan map reproduces G005/G023/G026/G064 as renamed-only; every copy is live via parseThetaDocument→checkStructural→walkStatements→walkStatement/walkExpr; the invoke-arm divergence (no annotationSourceIsNotTypeExpression, "inline-object-shape" flag) is accurately accounted; not a duplicate of PTQ-0364/0374 (invoke-static-checks.ts) nor of the D9 sibling intake d9-06 (breakdown lens) (triage: claude-fable-5-1)
