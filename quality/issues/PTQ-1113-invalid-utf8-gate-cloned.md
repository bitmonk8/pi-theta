...
## Triage
verdict: confirmed — both excerpts match verbatim at lexer.ts:95-108 and theta-document.ts:1046-1067; clone-scan reproduces G060 (65 tokens, renamed-only, lexer.ts:73-104 / theta-document.ts:1030-1060); both hosts live from src callers (parseThetaDocument ← pass-parse-cache.ts:110,149; lexTheta ← theta-document.ts:1095,2177,2206,10533); implementation of lexical.md §Encoding, not a spec vector table; drift breakage stated (lexer/parser disagreeing on refusal/offset); no existing PTQ tracks this gate (PTQ-0135/0254 are narration/D7, D9 intake siblings are breakdowns) (triage: claude-fable-5-1)
