...
verdict: confirmed — re-verified: production-theta-producer.ts:1754-1755 cites `theta-composition-producer.ts:103` / `called at :527`; grep shows `paramBindingsFrom` declared at :96 and its sole call at :585, and :527 is `invocationTicket?.finish()` inside setup-throw cleanup; PTQ-0069 (resolved) recorded this citation as holding on 2026-09-07 so the drift is new, and sibling intake d2-12 targets a different comment (inbound-boundary.ts), not a duplicate (triage: claude-fable-5-1)
