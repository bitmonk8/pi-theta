...
## Triage
verdict: confirmed — both excerpts verified verbatim at :86-88 and :1369-1372 (blame 28c730ad, bug-0154 v0.165.0) while the bug-0249 fix (53cd0d86, v0.240.0) landed the `reserved-keyword-as-identifier` push at :1591 in that same arm, and no reserved-keyword report is open (0153 fixed 0.194.0, 0249 fixed 0.240.0), so the "stays with its own open report" deferral is historical narration; distinct from the rule-counts and seam-stub candidates, which cite neither bullet (triage: claude-opus-5)
