...
## Triage
verdict: confirmed — both excerpts match verbatim at the cited lines, clone-scan reproduces G016 (98 tokens, renamed-only, 2848-2872 / 3675-3700), grep for `resolvePiTool: (name) =>` yields exactly those 2 sites, both enclosing functions are live (called at 1383/4299 and 3798), and the module's own bug-0487 comment at line 973 documents the pair as one admission rule that must be edited in lockstep; no tracked PTQ covers this src-side clone (0698/0712/1015 are D7 test-side, 0349 is D8) (triage: claude-fable-5-1)
