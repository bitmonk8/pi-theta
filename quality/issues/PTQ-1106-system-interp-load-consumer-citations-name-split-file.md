...
## Triage
verdict: confirmed — both excerpts match at :68-70 and :488-492; grep confirms import-static-checks.ts contains neither LOAD_SYSTEM_INTERP_BAD_FIELD_CODE nor toInterpolationType (exit 1) while import-system-template-patch.ts imports both (:19, :21) and uses them (:65, :251); blame dates citations to 401a425b (2026-09-04) and the split file to 6a68f58c (2026-09-14); no tracked issue covers these citations (PTQ-0067 is different lines, PTQ-0304 is the D9 split itself) (triage: claude-fable-5-1)
