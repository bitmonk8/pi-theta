...
## Triage
verdict: confirmed — re-verified: grep gives five live call sites (9107/9227/9276/9710/9887) while the doc block at 8403/8410 still says "the four call sites"/"the four new captures"; git shows 76489c61 (0262) wrote "four" when four existed, bb7546e0 (0273) added the fifth, and 8b39e071 (0277) later edited the block yet left "four" though its own message enumerates five filtered positions (the 7577 roster is the weaker of the two sites — 0273 authored it contemporaneously) (triage: claude-opus-5)
