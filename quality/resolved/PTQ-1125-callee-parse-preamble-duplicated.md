...
## Triage
verdict: confirmed — both excerpts match verbatim at :2444-2473 / :2492-2524 on HEAD; clone-scan map on production-composition.ts reproduces G011 (103 tokens, renamed-only) at exactly those ranges; the readBytes/parseViaPassCache/frontmatter-null-or-hasLoadParseError preamble is byte-identical and both functions are live (composed at :1460-1463 into checkInvokeStaticResolution deps, consumed by invoke-expr-call-surface.ts:452/472 and invoke-static-checks.ts:744); the :2497 doc-comment declares the second "parallel to resolveCalleeArity" so the shared resolvability contract is intended, not incidental; no spec vector table; resolveCalleeReturnType landed in 4dff8e49 (bug 0473) after PTQ-0322's inventory and none of the six resolved issues naming resolveCalleeArity (D9 0321/0322/0351/0413, D7 0557/0702) tracks this preamble clone; no exemptions.json row for the host — mechanical dedupe (triage: claude-fable-5-1)
