...
verdict: confirmed — human ruling (thomasa, 2026-09-11): accept - a wrong numeral in a module header is a defect regardless of provenance; recast the opening sentence as the module's current role (house rule: WHY not WHAT, no historical narration), leave bug 0088 to its bug doc
