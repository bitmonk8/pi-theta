...
verdict: questionable — accounting verified: size-scan still gives composeExtensionInstance 2428-2659, 232 LOC, band strong (FN strong ≥ 200), with the nested installHotReload at 2596-2657, 62 LOC, zone; the 2539-2545 excerpt is verbatim; the construct-once chain (emitToast/channel/loadSink/root/registries/statusBus/control plane, 2467-2538) and the return-wiring/rediscover closure (2587-2659) are separable concerns, though the inventory's row-6 range 2558-2594 overlaps the return at 2587, which is small drift; makeLoadNoteSink/wireRunCardSink/dialParentResultChannel exist at 2662/2736/2787 and ComposeOneThetaDeps at 1722; exemptions.json has 0 production-composition keys; the ≥6-shared-locals reason is argued rather than missed, and Decision 6/EXST-2 pin identity, not placement; not a duplicate, since PTQ-1160/1439 are status fixed in quality/resolved and no quality/issues file carries this d9_host; the rediscover closure (2608-2643) is mostly a second 16-arg runComposePass call, so the Seam A size is overstated but non-binding; the breakdown shape needs a human ruling (triage: claude-opus-5-5)
