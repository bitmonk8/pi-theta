...
verdict: questionable — accounting verified; target shape needs a human ruling: I re-ran size-scan and got 5157 LOC, band strong (file strong ≥ 2000); the declaration anchors for the tools family (2850-4771), buildSystemNoteDeps (4780), probe/peer (4825-4997), bootstrap sink (5011-5116) and productionSchemaSlugOf (5128) match the inventory; the PTQ-0322 PRE-ANNOUNCED A+C / B' quote is verbatim and only production-discovered-theta.ts exists; there is no module-level let/var; 0 @generated/DO NOT EDIT hits; no exemptions.json key covers this host; no other issue or intake file uses this file-level d9_host; no strong reason was overlooked (triage: claude-opus-5-5)
